...
[Sample("Benchmark", "CreateDestroy")]
public class CreateDestroy : SampleBase
{
    ...
    public CreateDestroy(Settings settings)
        : base(settings)
    {
        ...
        m_iterations = Core.B2Debug ? 1 : 10;
        m_bodyCount = 0;
    }
    ...
    public override void PreStep()
    {
        ...
        _ms = timer.ElapsedMilliseconds;
    }

    protected override void OnRender()
    {
        DrawString($"milliseconds = {_ms}");
        base.OnRender();
    }
}